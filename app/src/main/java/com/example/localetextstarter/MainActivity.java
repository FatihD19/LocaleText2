...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String formattedExpirationDate = DateFormat.getDateInstance().format(myDate);
        expiredDateTextView.setText(formattedExpirationDate);
        ...
        if(deviceLocale == "ID"){
            mPrice = mPrice* mIUdExchangeRate;
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        // TODO: Homework: Use currency format for France (FR) or arab
